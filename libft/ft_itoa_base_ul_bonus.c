...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_itoa_base_ul_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jdurand <jdurand@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/09 18:17:17 by jdurand           #+#    #+#             */
/*   Updated: 2019/10/30 19:19:00 by jdurand          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	ft_nbrlen_base(unsigned long nbr, int baselen)
{
	int	nbrlen;
	...
	while (nbr >= (unsigned long)baselen)
	{
		nbr /= baselen;
		nbrlen = nbrlen + 1;
	}
